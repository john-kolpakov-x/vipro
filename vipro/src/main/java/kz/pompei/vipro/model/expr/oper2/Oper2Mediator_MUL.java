...
import kz.pompei.vipro.model.expr.visitor.draw.oper2.ExprDrawer_MUL;

public class Oper2Mediator_MUL implements Oper2Mediator {
  @Override
  public ExprDrawer createDrawer(Expr expr1, Expr expr2, DrawVisitor drawVisitor) {
    return new ExprDrawer_MUL(expr1, expr2, drawVisitor);
  }
}
