...
import kz.pompei.vipro.model.expr.visitor.draw.oper2.ExprDrawer_AND;

public class Oper2Mediator_AND implements Oper2Mediator {
  @Override
  public ExprDrawer createDrawer(Expr expr1, Expr expr2, DrawVisitor drawVisitor) {
    return new ExprDrawer_AND(expr1, expr2, drawVisitor);
  }
}
